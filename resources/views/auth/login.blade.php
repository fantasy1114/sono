...
<head>
    ...
    <style>
        @font-face {
            ...
            src: url('{{asset('fonts/normal/Poppins-Bold.ttf')}}') format('truetype');
        }
                ...
                <div class="card" style="">
                    ...
                    <div class="card-body">
                        <div class="input-group input-group-merge login_input_margin_first">
                            ...
                            <input id="email" type="email"  name="email" style="border: none;background-color: #F8F8F8;" class="form-control @error('email') is-invalid @enderror" placeholder="User name" required autocomplete="email" />
                        </div>
