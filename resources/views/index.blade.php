...
<head>
    ...
    <title>{{ config('app.name', 'SONO Portal') }}</title>
...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="{!! url('/') !!}" class="navbar-brand">{{ config('app.name', 'SONO Portal') }}</a>
        </div>
    ...
    <div class="container body-content">
        @yield('content')
                This is an Alpha version. Don't expect much!
                <p><p><p>
                <a href="{{ route('organisations.organisation.index') }}">Organisations</a><p>
                <a href="/managers">Managers</a><p>
                <a href="/worksites">Worksites</a><p>
                <a href="/employees">Employees</a><p>
                <a href="/keys">Keys</a><p>
                <a href="/registries">Registry</a><p>
    </div>
