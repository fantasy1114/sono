    ...
    <div class="nav-wrapper">
      ...
      <ul class="navbar-list right mr-2">
        <li class="dropdown-language">
          <a class="waves-effect waves-block waves-light russia_lang language__font__size" href="{{url('lang/ru')}}" data-language="ru" style="color:#71FFDC;">
            RU
          </a>
        </li>
        <li class="dropdown-language">
          <a class="waves-effect waves-block waves-light english_lang language__font__size" href="{{url('lang/en')}}" data-language="en" style="color:#71FFDC;">
            EN
          </a>
        </li>
        <li class="dropdown-language ">
          <a class="waves-effect waves-block waves-light lvtian_lang language__font__size" href="{{url('lang/lv')}}" data-language="lv" style="color:#71FFDC;">
            LV
          </a>
        </li>
        <li class="dropdown-language">
