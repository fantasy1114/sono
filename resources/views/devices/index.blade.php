...
<section class="users-list-wrapper section @if(Auth::user()->is_superuser == 0) {{'d-none'}} @endif">
    ...
    <div class="col-12 valign-wrapper edit_title_posotion main_page_border">
        ...
        <div class="col s3 m3 l3 right-align">
            <a href="{{ route('devices.device.create') }}" class="btn waves-effect waves-light d-flex align-items-center float-right mr-2 create_new_product">
              <div class="d-inline">add</div><i class="material-icons" title="{{ trans('devices.create') }}">add</i>
            </a>
        </div>
    </div>
                      ...
                      <tbody>
                        @foreach($devices as $device)
                          <tr>
                            ...
                            <td>{{ ($device->Is_Active) ? trans('locale.Yes') : trans('locale.No') }}</td>
