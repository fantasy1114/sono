...
<section class="users-list-wrapper section">
    ...
    <div class="row">
        <div class="col s6 m6 l6 left-align">
            <input class="btn btn-primary green" type="submit" value="{{ trans('keys.update') }}">
            </form>
        ...
        <div class="col s2 m2 l2 right-align">
            <form method="POST" action="{!! route('keys.key.destroy', $key->Key_ID) !!}" accept-charset="UTF-8">
                ...
                <input class="btn btn-primary red" onclick="return confirm(&quot;{{ trans('keys.confirm_delete') }}&quot;)" type="submit" value="{{ trans('locale.deletes') }}">
            </form>
        </div>
