...
<section class="users-list-wrapper section mobile_indexpage @if(Auth::user()->is_superuser == 0) {{'d-none'}} @endif">
    ...
    <div class="col-12 valign-wrapper edit_title_posotion main_page_border pb-2">
        ...
        <div class="col s3 m3 l3 right-align edit_title_posotion_create">
            <a href="{{ route('managers.manager.create') }}" class="btn waves-effect waves-light d-flex align-items-center float-right mr-2 create_new_product">
                <div class="d-inline">add</div><i class="material-icons" title="{{ trans('managers.create') }}">add</i>
            </a>
        </div>
    </div>
    <div class="col-12">
    ...
    <div class="row">
        ...
        <div class="col-12 webmobile_design mt-2">
            <div class="card-panel rounded mx-sm-1 px-sm-4">
                ...
                <div class="row mt-5">
                    <div class="col-sm-3">
                        <input class="btn btn-primary btn_update px-lg-3 update_update" type="submit" value="{{ trans('managers.update') }}">
                        </form>
                    </div>
                    <div class="col-sm-9 update_delete">
                        <div class="float-left">
                            <a href="{{ route('managers.manager.index') }}" class="btn waves-effect waves-light px-lg-3 darken-2 update_delete_cancel">{{ trans('locale.cancels') }}</a>
                        </div>
