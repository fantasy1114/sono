<div class="row py-2">
        ...
        <div class="col-md-6 card-width">
            <div class="input-field {{ $errors->has('Worksite_Name') ? 'has-error' : '' }}">
                ...
                <div class="form-group">
                    <input type="text" style="" name="Worksite_Name" id="Worksite_Name" value="{{ old('Worksite_Name', optional($worksite)->Worksite_Name) }}" minlength="1" maxlength="64" required="true" class="form-control pl-0 placeholder_font validate" placeholder="{{ trans('worksites.Worksite_Name__placeholder') }}" />
        ...
        <div class="col-md-6 card-width">
            <div class="input-field {{ $errors->has('Organisation_ID') ? 'has-error' : '' }}">
                <label for="Organisation_ID" class="active font_lable">{{ trans('worksites.Organisation_ID') }}</label>
