    ...
    <div class="row">
        ...
        <div class="col-12 webmobile_design mt-2">
            <div class="card-panel rounded mx-sm-1 px-sm-4">
                ...
                <div class="row mt-5">
                    <div class="col-sm-3">
                        <input class="btn btn-primary btn_update px-lg-3 update_update" type="submit" value="{{ trans('worksites.update') }}">
                        </form>
                    </div>
                    <div class="col-sm-9 update_delete">
                        <div class="float-left">
                            <a href="{{ route('worksites.worksite.index') }}" class="btn waves-effect waves-light px-lg-3 darken-2 update_delete_cancel">{{ trans('locale.cancels') }}</a>
                        </div>
                        <div class="float-right update_delete_delete">
                            <form method="POST" action="{!! route('worksites.worksite.destroy', $worksite->Worksite_ID) !!}" accept-charset="UTF-8">
                                ...
                                <input class="btn btn-primary px-lg-3 update_delete_delete_back" onclick="return confirm(&quot;{{ trans('worksites.confirm_delete') }}&quot;)" type="submit" value="{{ trans('locale.deletes') }}">
                            </form>
                        </div>
                    </div>
                </div>
