...
<section class="users-list-wrapper section mobile_indexpage">
    ...
    <div class="col-11 valign-wrapper edit_title_posotion main_page_border">
        <div class="left-align">
            <h5 class="white-text">{{ trans('worksites.create') }}</h5>
        </div>
        <!-- "Go Up" button -->
    ...
    <form method="POST" action="{{ route('worksites.worksite.store') }}" accept-charset="UTF-8" 
            ...
            <div class="card-panel mb-6 rounded col-12 px-md-4">
                ...
                <div class="row mt-5">
                    <div class="col-12">
                        ...
                        <a href="{{ route('worksites.worksite.index') }}" class="btn waves-effect waves-light darken-2 px-lg-3 create_de">{{ trans('locale.cancels') }}</a>
                    </div>
