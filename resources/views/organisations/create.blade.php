...
<section class="users-list-wrapper section mobile_indexpage @if(Auth::user()->is_superuser == 0) {{'d-none'}} @endif">
    ...
    <div class="col-11 valign-wrapper edit_title_posotion main_page_border">
        <div class="col s9 m9 l9 left-align">
            <h5 class="white-text">{{ trans('organisations.create') }}</h5>
        </div>
        <!-- "Go Up" button -->
    ...
    <form method="POST" action="{{ route('organisations.organisation.store') }}" accept-charset="UTF-8" id="create_organisation_form" name="create_organisation_form" class="form-horizontal">
    <div class="row">
        <!-- Edit Form -->
            ...
            <div class="card-panel mb-6 rounded col-12 px-md-4">
                ...
                <div class="col-12 mt-5">
                    <div class="left-align">
                        ...
                        <a href="{{ route('organisations.organisation.index') }}" class="btn waves-effect waves-light px-lg-3 create_de darken-2">{{ trans('locale.cancels') }}</a>
                    </div>
