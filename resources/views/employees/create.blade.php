...
<section class="users-list-wrapper section edit__index__page">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="left-align">
            <h5 class="white-text indexpage__title__size">{{ trans('employees.create') }}</h5>
        </div>
        ...
        <div class="col-12 edit__page__position">
            ...
            <div class="row">
                <div class="col-12 edit__btns__group">
                    ...
                    <a href="{{ route('employees.employee.index') }}" class="btn waves-effect waves-light darken-2 create__cancel__btn">{{ trans('locale.cancels') }}</a>
                </div>
