...
<section class="users-list-wrapper section">
    ...
    <div class="row valign-wrapper mb-1 mt-1">
        <div class="col s9 m9 l9 left-align">
            <h5 class="white-text">{{ trans('registries.create') }}</h5>
        </div>
        <!-- "Go Up" button -->
    ...
    <form method="POST" action="{{ route('registries.registry.store') }}" accept-charset="UTF-8" 
        id="create_registry_form" name="create_registry_form" class="form-horizontal">
    <div class="row">
        <!-- Edit Form -->
    ...
    <div class="row">
        <div class="col s6 m6 l6 left-align">
            ...
            <a href="{{ route('registries.registry.index') }}" class="btn waves-effect waves-light blue darken-2">{{ trans('locale.cancels') }}</a>
        </div>
