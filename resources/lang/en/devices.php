...
return [
    'Device_ID' => 'Device',
    'Device_ID__placeholder' => 'Select device',
    'Tracker_Code' => 'Tracker  Code',
    'Tracker_Code__placeholder' => 'Enter tracker  code here...',
    ...
    'index_route_description' => 'Retrieve existing devices.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the device property name where the value is the assigned value to the retrieved device.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved device.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of devices per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved device.',
    ...
    'update_route_description' => 'Update existsing device.',
    ...
    'the_id_of_model_to_delete' => 'The id of the device to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete devices.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the device.',
    ...
    'the_requested_model_does_not_exists' => 'The requested device does not exists.',
    ...
    'edit' => 'Edit Device',
    'show' => 'Show Device',
    'show_all' => 'Show All Device',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Device.',
    'none_available' => 'No Devices Available.',
    'model_plural' => 'Devices',
    'model_was_added' => 'Device was successfully added.',
    'model_was_retrieved' => 'Device was successfully retrieved.',
    'models_were_retrieved' => 'Devices were successfully retrieved.',
    'model_was_updated' => 'Device was successfully updated.',
    'model_was_deleted' => 'Device was successfully deleted.',
