...
return [
    ...
    'Organisation_Name__placeholder' => 'Enter organisation  name here...',
    ...
    'index_route_description' => 'Retrieve existing organisations.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the organisation property name where the value is the assigned value to the retrieved organisation.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved organisation.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of organisations per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved organisation.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new organisation.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing organisation.',
    ...
    'show_route_description' => 'Retrieve existsing organisation.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the organisation to retrieve',
    'destroy_route_description' => 'Delete existsing organisation.',
    ...
    'the_id_of_model_to_delete' => 'The id of the organisation to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete organisations.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the organisation.',
    ...
    'the_requested_model_does_not_exists' => 'The requested organisation does not exists.',
    ...
    'show' => 'Show Organisation',
    'show_all' => 'Show All Organisation',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Organisation.',
    'none_available' => 'No Organisations Available.',
    'model_plural' => 'Organisations',
    'model_was_added' => 'Organisation was successfully added.',
    'model_was_retrieved' => 'Organisation was successfully retrieved.',
    'models_were_retrieved' => 'Organisations were successfully retrieved.',
    'model_was_updated' => 'Organisation was successfully updated.',
    'model_was_deleted' => 'Organisation was successfully deleted.',
    ...
    'model_id_camel_case' => 'organisationId',
