...
return [
    ...
    'Registry_ID__placeholder' => 'Select registry',
    'Key_Name' => 'Key  Name',
    'Key_Name__placeholder' => 'Enter key  name here...',
    'Action' => 'Action',
    'Action__placeholder' => 'Enter action here...',
    'Action_Time' => 'Action  Time',
    'Action_Time__placeholder' => 'Enter action  time here...',
    'Battery_State' => 'Battery  State',
    'Battery_State__placeholder' => 'Enter battery  state here...',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing registries.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the registry property name where the value is the assigned value to the retrieved registry.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved registry.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of registries per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved registry.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new registry.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing registry.',
    ...
    'show_route_description' => 'Retrieve existsing registry.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the registry to retrieve',
    'destroy_route_description' => 'Delete existsing registry.',
    ...
    'the_id_of_model_to_delete' => 'The id of the registry to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete registries.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the registry.',
    ...
    'the_requested_model_does_not_exists' => 'The requested registry does not exists.',
    ...
    'edit' => 'Edit Registry',
    'show' => 'Show Registry',
    'show_all' => 'Show All Registry',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Registry.',
    'none_available' => 'No Registries Available.',
    'model_plural' => 'Registries',
    'model_was_added' => 'Registry was successfully added.',
    'model_was_retrieved' => 'Registry was successfully retrieved.',
    'models_were_retrieved' => 'Registries were successfully retrieved.',
    'model_was_updated' => 'Registry was successfully updated.',
    'model_was_deleted' => 'Registry was successfully deleted.',
    'unexpected_error' => 'Unexpected error occurred while trying to process your request.',
    'Key' => 'Key',
    'Employee' => 'Employee',
    'Worksite' => 'Worksite',
    'Event' => 'Event',
    'Event Time and Date' => 'Event Time and Date',
    'Battery, V' => 'Battery, V',
    ...
    'model_id_camel_case' => 'registryId',
