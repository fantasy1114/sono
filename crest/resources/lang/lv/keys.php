...
return [
    'Key_ID' => 'Key',
    'Key_ID__placeholder' => 'Select key',
    'Key_Name' => 'Key  Name',
    ...
    'index_route_description' => 'Retrieve existing keys.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the key property name where the value is the assigned value to the retrieved key.',
    ...
    'show_route_description' => 'Retrieve existsing key.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the key to retrieve',
    'destroy_route_description' => 'Delete existsing key.',
    ...
    'the_id_of_model_to_delete' => 'The id of the key to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete keys.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the key.',
    ...
    'the_requested_model_does_not_exists' => 'The requested key does not exists.',
    ...
    'edit' => 'Edit Key',
    'show' => 'Show Key',
    'show_all' => 'Show All Key',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Key.',
    'none_available' => 'No Keys Available.',
    'model_plural' => 'Keys',
    'model_was_added' => 'Key was successfully added.',
    'model_was_retrieved' => 'Key was successfully retrieved.',
    'models_were_retrieved' => 'Keys were successfully retrieved.',
    'model_was_updated' => 'Key was successfully updated.',
    'model_was_deleted' => 'Key was successfully deleted.',
