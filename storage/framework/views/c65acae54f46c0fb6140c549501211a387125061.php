...
<section class="users-list-wrapper section edit__index__page <?php if(Auth::user()->is_superuser == 0): ?> <?php echo e('d-none'); ?> <?php endif; ?>">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(isset($title) ? $title : trans('organisations.model_plural')); ?></h5>
        </div>
        <div class="col s3 m3 l3 right-align">
            <a href="<?php echo e(route('organisations.organisation.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right edit__add__btn">
            ...
            <div class="card-panel edit__page__table">
                ...
                <div class="row edit__btns__group">
                    <div class="col-sm-3 col-xl-2">
                        <input class="btn btn-primary editpage__update__btn" type="submit" value="<?php echo e(trans('organisations.update')); ?>">
                        </form>
                    </div>
                    <div class="col-sm-9 col-xl-10">
                        <div class="float-left">
                            <a href="<?php echo e(route('organisations.organisation.index')); ?>" class="btn waves-effect waves-light darken-2 editpage__cancel__btn"><?php echo e(trans('locale.cancels')); ?></a>
                        </div>
                        ...
                        <div class="float-right">
                            <form method="POST" action="<?php echo route('organisations.organisation.destroy', $organisation->Organisation_ID); ?>" accept-charset="UTF-8">
                                ...
                                <input class="btn btn-primary editpage__delete__btn" onclick="return confirm(&quot;<?php echo e(trans('organisations.confirm_delete')); ?>&quot;)" type="submit" value="<?php echo e(trans('locale.deletes')); ?>">
                            </form>
                        </div>
                    </div>
