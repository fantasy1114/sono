...
<section class="users-list-wrapper section edit__index__page">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="col s9 m9 l9 left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(trans('keys.create')); ?></h5>
        </div>
            ...
            <div class="card-panel edit__page__table">
                ...
                <div class="row">
                    <div class="col-12 edit__btns__group">
                        ...
                        <a href="<?php echo e(route('keys.key.index')); ?>" class="btn waves-effect waves-light darken-2 create__cancel__btn"><?php echo e(trans('locale.cancels')); ?></a>
                    </div>
