...
<section class="users-list-wrapper section edit__index__page <?php if(Auth::user()->is_superuser == 0): ?> <?php echo e('d-none'); ?> <?php endif; ?>">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(trans('organisations.create')); ?></h5>
        </div>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('organisations.organisation.store')); ?>" accept-charset="UTF-8" id="create_organisation_form" name="create_organisation_form" class="form-horizontal">
    <div class="row">
        <!-- Edit Form -->
            ...
            <div class="card-panel edit__page__table">
                ...
                <div class="col-12 edit__btns__group">
                    <div class="left-align">
                        ...
                        <a href="<?php echo e(route('organisations.organisation.index')); ?>" class="btn waves-effect waves-light  darken-2 create__cancel__btn"><?php echo e(trans('locale.cancels')); ?></a>
                    </div>
