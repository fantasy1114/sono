...
<section class="users-list-wrapper section <?php if(Auth::user()->is_superuser == 0): ?> <?php echo e('d-none'); ?> <?php endif; ?>">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="">
            <h5 class="white-text indexpage__title__size"><?php echo e(trans('organisations.model_plural')); ?></h5>
            <p class="indexpage__user__explain" style="visibility: hidden;"><?php echo auth()->user()->renderOrgName(); ?></p>
        </div>
        <div class="col m3 right-align">
            <a href="<?php echo e(route('organisations.organisation.create')); ?>" class=" btn waves-effect waves-light d-flex align-items-center float-right <?php echo e(auth()->user()->is_superuser ? '' : 'disabled'); ?> indexpage__add__btn">
            ...
            <div class="card">
              <div class="py-3">
                    <table id="page-length-option" class="display">
                      <thead>
                        <tr>
                          <th class="px-3"><?php echo e(trans('organisations.Organisation_Name')); ?></th>
                      ...
                      <tbody>
                        <?php $__currentLoopData = $organisations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organisation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td class="px-3"><?php echo e($organisation->Organisation_Name); ?></td>
                            <form method="POST" action="<?php echo route('organisations.organisation.destroy', $organisation->Organisation_ID); ?>" accept-charset="UTF-8">
                              <td>
                                <a class="btn-flat" href="<?php echo e(route('organisations.organisation.show', $organisation->Organisation_ID )); ?>"><i class=""><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn-flat" href="<?php echo e(route('organisations.organisation.edit', $organisation->Organisation_ID )); ?>"><i class=""><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script src="<?php echo e(('table/js/scripts/data-tables-ora.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>
