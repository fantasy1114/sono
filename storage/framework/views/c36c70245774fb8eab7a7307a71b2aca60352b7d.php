...
<section class="users-list-wrapper section">
    ...
    <div class="row valign-wrapper mb-1 mt-1">
        <div class="col s12 m12 l12 left-align">
            <h5 class="white-text"><?php echo e(isset($title) ? $title : 'Key'); ?></h5>
        </div>
    </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\data\li\webde\resources\views/keys/show.blade.php ENDPATH**/ ?>