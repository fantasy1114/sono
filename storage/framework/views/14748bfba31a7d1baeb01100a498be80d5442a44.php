...
<section class="users-list-wrapper section mobile_indexpage <?php if(Auth::user()->is_superuser == 0): ?> <?php echo e('d-none'); ?> <?php endif; ?>">
    ...
    <div class="col-12 valign-wrapper edit_title_posotion main_page_border pb-2">
        ...
        <div class="col s3 m3 l3 right-align edit_title_posotion_create">
            <a href="<?php echo e(route('devices.device.index')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right mr-2 create_new_product">
                <div class="d-inline">add</div><i class="material-icons" title="<?php echo e(trans('devices.create')); ?>">arrow_upward</i>
            </a>
        </div>
    </div>
    <div class="col-12">
    ...
    <div class="row">
        ...
        <div class="col-12 webmobile_design mt-2">
            <div class="card-panel rounded mx-sm-1 px-sm-4">
                ...
                <div class="row mt-5">
                    <div class="col-sm-3">
                        <input class="btn btn-primary btn_update px-lg-3 update_update" type="submit" value="<?php echo e(trans('devices.update')); ?>">
                        </form>
                    </div>
                    <div class="col-sm-9 update_delete">
                        <div class="float-left">
                            <a href="<?php echo e(route('devices.device.index')); ?>" class="btn waves-effect waves-light px-lg-3 darken-2 update_delete_cancel"><?php echo e(trans('locale.cancels')); ?></a>
                        </div>
                        <div class="float-right update_delete_delete">
                            <form method="POST" action="<?php echo route('devices.device.destroy', $device->Device_ID); ?>" accept-charset="UTF-8">
                                ...
                                <input class="btn btn-primary px-lg-3 update_delete_delete_back" onclick="return confirm(&quot;<?php echo e(trans('devices.confirm_delete')); ?>&quot;)" type="submit" value="<?php echo e(trans('locale.deletes')); ?>">
                            </form>
                        </div>
                    </div>
