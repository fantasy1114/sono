...
<section class="users-list-wrapper section edit__index__page">
    ...
    <div class="row valign-wrapper index__solid__border">
      <div class="col-12">
        <a href="<?php echo e(route('worksites.worksite.index')); ?>" class="btn-floating btn waves-effect waves-light show__back__btn ml-md-2">
          <i class="material-icons" title="<?php echo e(trans('worksites.create')); ?>">arrow_back</i>
        </a>
        <h5 class="white-text d-md-inline align-middle indexpage__title__size show__index__name ml-md-2"><?php echo e(trans('locale.Work sites')); ?></h5>
        <a href="<?php echo e(route('worksites.worksite.create')); ?>" class="btn waves-effect waves-light float-right show__add__btn">
        ...
        <div class="card-content row">
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('worksites.Worksite_Name')); ?></label>
                
                <div class="form-group">
                    <input type="text" value="<?php echo e($worksite->Worksite_Name); ?>" class="form-control pl-0 placeholder_fonts validate" />
                </div>
          ...
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('worksites.Worksite_Address')); ?></label>
                
                <div class="form-group">
                    <input type="text" value="<?php echo e($worksite->Worksite_Address); ?>" class="form-control validate" />
                </div>
          ...
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('worksites.Is_Active')); ?></label>
                
                <div class="form-group">
                    <input type="text" value="<?php echo e(($worksite->Is_Active) ? trans('locale.Yes') : trans('locale.No')); ?>" class="form-control validate" />
                </div>
          ...
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('worksites.Organisation_ID')); ?></label>
                
                <div class="form-group">
                  <input type="text" value="<?php echo e($worksite->Organisation_ID); ?>" class="form-control pl-0 placeholder__location validate" />
                </div>
          ...
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('worksites.Created_At')); ?></label>
                
                <div class="form-group">
                  <input type="text" value="<?php echo e(date('d.m.Y H:i', strtotime(str_replace('/', '-', $worksite->Created_At)))); ?>" class="form-control pl-0 validate" />
                </div>
          ...
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('worksites.Updated_At')); ?></label>
                
                <div class="form-group">
                  <input type="text" value="<?php echo e(date('d.m.Y H:i', strtotime(str_replace('/', '-', $worksite->Updated_At)))); ?>" class="form-control pl-0 validate" />
                </div>
