...
<section class="users-list-wrapper section edit__index__page <?php if(Auth::user()->is_superuser == 0): ?> <?php echo e('d-none'); ?> <?php endif; ?>">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(trans('devices.create')); ?></h5>
        </div>
    ...
    <form method="POST" action="<?php echo e(route('devices.device.store')); ?>" accept-charset="UTF-8" 
            ...
            <!-- Errors here, if present -->
                ...
                <div class="row">
                    <div class="col-12 edit__btns__group">
                        ...
                        <a href="<?php echo e(route('devices.device.index')); ?>" class="btn waves-effect waves-light darken-2 create__cancel__btn"><?php echo e(trans('locale.cancels')); ?></a>
                    </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\data\10.30\li\webde\resources\views/devices/create.blade.php ENDPATH**/ ?>