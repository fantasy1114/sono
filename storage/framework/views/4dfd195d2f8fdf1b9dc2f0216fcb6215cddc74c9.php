...
<section class="users-list-wrapper section mobile_indexpage <?php if(Auth::user()->is_superuser == 0): ?> <?php echo e('d-none'); ?> <?php endif; ?>">
    ...
    <div class="col-11 valign-wrapper edit_title_posotion main_page_border">
        <div class="left-align">
            <h5 class="white-text"><?php echo e(trans('devices.create')); ?></h5>
        </div>
        <!-- "Go Up" button -->
            ...
            <!-- Errors here, if present -->
                ...
                <div class="row mt-5">
                    <div class="col-12 left-align">
                        ...
                        <a href="<?php echo e(route('devices.device.index')); ?>" class="btn waves-effect waves-light darken-2 px-lg-3 create_de"><?php echo e(trans('locale.cancels')); ?></a>
                    </div>
