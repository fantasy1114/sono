...
<section class="users-list-wrapper section edit__index__page <?php if(Auth::user()->is_superuser == 0): ?> <?php echo e('d-none'); ?> <?php endif; ?>">
    ...
    <div class="row valign-wrapper index__solid__border">
        <div class="col-12">
            <a href="<?php echo e(route('devices.device.index')); ?>" class="btn-floating btn waves-effect waves-light show__back__btn ml-md-2">
              <i class="material-icons" title="<?php echo e(trans('devicess.create')); ?>">arrow_back</i>
            </a>
            <h5 class="white-text d-md-inline align-middle indexpage__title__size show__index__name ml-md-2"><?php echo e(isset($title) ? $title : trans('devices.model_plural')); ?></h5>
            <a href="<?php echo e(route('devices.device.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right show__add__btn">
        ...
        <div class="card-content row">
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('devices.Tracker_Code')); ?></label>
                <div class="form-group">
                    <input type="text" value="<?php echo e($device->Tracker_Code); ?>" class="form-control pl-0 placeholder_fonts validate" />
                </div>
            </div>
          </div>
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('devices.Worksite_ID')); ?></label>
                <div class="form-group">
                    <input type="text" value="<?php echo e(optional($device->Worksite)->Worksite_Name); ?>" class="form-control pl-0 placeholder_fonts validate" />
                </div>
            </div>
          </div>
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('devices.Is_Active')); ?></label>
                <div class="form-group">
                    <input type="text" value="<?php echo e(($device->Is_Active) ? trans('locale.Yes') : trans('locale.No')); ?>" class="form-control pl-0 placeholder_fonts validate" />
                </div>
            </div>
          </div>
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('devices.Created_At')); ?></label>
                <div class="form-group">
                    <input type="text" value="<?php echo e(date('d.m.Y H:i', strtotime(str_replace('/', '-', $device->Created_At)))); ?>" class="form-control pl-0 placeholder_fonts validate" />
                </div>
            </div>
          </div>
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                <label class="active font_lable"><?php echo e(trans('devices.Updated_At')); ?></label>
                <div class="form-group">
                    <input type="text" value="<?php echo e(date('d.m.Y H:i', strtotime(str_replace('/', '-', $device->Updated_At)))); ?>" class="form-control pl-0 placeholder_fonts validate" />
                </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\data\10.30\li\webde\resources\views/devices/show.blade.php ENDPATH**/ ?>