...
<section class="users-list-wrapper section edit__index__page">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(isset($title) ? $title : trans('employees.model_plural')); ?></h5>
        </div>
        <!-- "Go Up" button -->
        <div class="col s3 m3 l3 right-align">
            <a href="<?php echo e(route('employees.employee.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right edit__add__btn">
                <div class="d-inline">add</div><i class="material-icons" title="<?php echo e(trans('employees.create')); ?>">add</i>
            </a>
        </div>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('employees.employee.update', $employee->Employee_ID)); ?>" 
    ...
    <div class="row">
        ...
        <div class="col-12 edit__page__position">
            <div class="card-panel mb-6 rounded">
                ...
                <div class="row edit__btns__group">
                    <div class="col-sm-3 col-xl-2">
                        <input class="btn btn-primary editpage__update__btn" type="submit" value="<?php echo e(trans('employees.update')); ?>">
                        </form>
                    </div>
                    <div class="col-sm-9 col-xl-10">
                        <div class="float-left ml-sm-5">
                            <a href="<?php echo e(route('employees.employee.index')); ?>" class="btn waves-effect waves-light darken-2 editpage__cancel__btn"><?php echo e(trans('locale.cancels')); ?></a>
                        </div>
                        <div class="float-right">
                            <form method="POST" action="<?php echo route('employees.employee.destroy', $employee->Employee_ID); ?>" accept-charset="UTF-8">
                                ...
                                <input class="btn btn-primary editpage__delete__btn" onclick="return confirm(&quot;<?php echo e(trans('employees.confirm_delete')); ?>&quot;)" type="submit" value="<?php echo e(trans('locale.deletes')); ?>">
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\data\10.30\li\webde\resources\views/employees/edit.blade.php ENDPATH**/ ?>