...
<section class="users-list-wrapper section mobile_indexpage">
    ...
    <div class="col-12 valign-wrapper edit_title_posotion main_page_border pb-2">
        <div class="left-align">
            <h5 class="white-text"><?php echo e(isset($title) ? $title : trans('employees.model_plural')); ?></h5>
        </div>
        <!-- "Go Up" button -->
        <div class="col s3 m3 l3 right-align">
            <a href="<?php echo e(route('employees.employee.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right mr-2 create_new_product">
    ...
    <div class="row">
        ...
        <div class="col s8 m8 l8">
            <div class="card-panel mb-6">
                ...
                <div class="row mt-5">
                    <div class="col-sm-3">
                        <input class="btn btn-primary btn_update px-lg-3 update_update" type="submit" value="<?php echo e(trans('employees.update')); ?>">
                        </form>
                    </div>
                    <div class="col-sm-9 update_delete">
                        <div class="float-left">
                            <a href="<?php echo e(route('employees.employee.index')); ?>" class="btn waves-effect waves-light px-lg-3 darken-2 update_delete_cancel"><?php echo e(trans('locale.cancels')); ?></a>
                        </div>
                        <div class="float-right update_delete_delete">
                            <form method="POST" action="<?php echo route('employees.employee.destroy', $employee->Employee_ID); ?>" accept-charset="UTF-8">
                                ...
                                <input class="btn btn-primary px-lg-3 update_delete_delete_back" onclick="return confirm(&quot;<?php echo e(trans('employees.confirm_delete')); ?>&quot;)" type="submit" value="<?php echo e(trans('locale.deletes')); ?>">
                            </form>
                        </div>
                    </div>
