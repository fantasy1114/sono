...
<section class="users-list-wrapper section">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="col s9 m9 l9 left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(trans('employees.model_plural')); ?></h5>
            <p class="indexpage__user__explain"><?php echo auth()->user()->renderOrgName(); ?></p>
        </div>
        <div class="col s3 m3 l3 right-align pr-0">
            <a href="<?php echo e(route('employees.employee.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right indexpage__add__btn">
              <div class="d-inline"><?php echo e(trans('locale.add')); ?></div><i class="material-icons" title="<?php echo e(trans('employees.create')); ?>">add</i>
            </a>
        </div>
    </div>
            ...
            <div class="card">
              <div class="py-3">
                    ...
                    <table id="page-length-option" class="display">
                      <thead>
                        <tr>
                          <th class="px-3"><?php echo e(trans('employees.Employee_Name')); ?></th>
                      ...
                      <tbody>
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td class="px-3"><?php echo e($employee->Employee_Name); ?></td>
                            <td><?php echo e($employee->Employee_Phone); ?></td>
                            <td><span class="<?php echo e(($employee->Is_Active) ? 'statusactive' : 'statusinactive'); ?>"><?php echo e(($employee->Is_Active) ? 'Active' : 'Inactive'); ?></span></td>
                            ...
                            <form method="POST" action="<?php echo route('employees.employee.destroy', $employee->Employee_ID); ?>" accept-charset="UTF-8">
                              <td class="">
                                <a class="btn-flat" href="<?php echo e(route('employees.employee.show', $employee->Employee_ID )); ?>"><i class=""><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn-flat" href="<?php echo e(route('employees.employee.edit', $employee->Employee_ID )); ?>"><i class=""><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\data\10.30\li\webde\resources\views/employees/index.blade.php ENDPATH**/ ?>