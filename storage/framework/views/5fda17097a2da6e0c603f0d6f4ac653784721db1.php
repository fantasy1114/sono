...
<section class="users-list-wrapper section mobile_indexpage">
    ...
    <div class="row valign-wrapper mb-1 mt-1">
      <div class="col s12 m12 l12 left-align">
        <a href="<?php echo e(route('keys.key.index')); ?>" class="btn-floating btn waves-effect waves-light ml-3 ml-lg-3 show_back">
          <i class="material-icons show_background" title="<?php echo e(trans('keys.create')); ?>">arrow_back</i>
        </a>
        <h5 class="white-text d-lg-inline align-middle ml-3 edit_title_posotion"><?php echo e(trans('locale.Keys')); ?></h5>
      </div>
    </div>
    <div class="col-12">
      ...
      <div class="card-content row">
        ...
        <div class="col-lg-6 col-12 card-width">
          <div class="input-field">
              ...
              <div class="form-group">
                  <input type="text" value="<?php echo e($key->Created_At); ?>" class="form-control pl-0 placeholder_fonts validate" />
              </div>
          </div>
        </div>
        <div class="col-lg-6 col-12 card-width">
          <div class="input-field">
              ...
              <div class="form-group">
                  <input type="text" value="<?php echo e($key->Updated_At); ?>" class="form-control pl-0 placeholder_fonts validate" />
              </div>
          </div>
        </div>
      </div>
