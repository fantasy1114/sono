...
<section class="users-list-wrapper section edit__index__page">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(trans('worksites.create')); ?></h5>
        </div>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('worksites.worksite.store')); ?>" accept-charset="UTF-8" id="create_worksite_form" name="create_worksite_form" class="form-horizontal">
    <div class="row">
        <!-- Edit Form -->
            ...
            <div class="card-panel edit__page__table">
                ...
                <div class="row ">
                    <div class="col-12 edit__btns__group">
                          ...
                          <a href="<?php echo e(route('worksites.worksite.index')); ?>" class="btn waves-effect waves-light darken-2 create__cancel__btn"><?php echo e(trans('locale.cancels')); ?></a>
