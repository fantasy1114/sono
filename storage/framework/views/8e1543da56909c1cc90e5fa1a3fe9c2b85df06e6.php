...
<section class="users-list-wrapper section edit__index__page">
    ...
    <div class="row valign-wrapper index__solid__border">
        <div class="col-12">
          <a href="<?php echo e(route('employees.employee.index')); ?>" class="btn-floating btn waves-effect waves-light show__back__btn ml-md-2">
            <i class="material-icons" title="<?php echo e(trans('employees.create')); ?>">arrow_back</i>
          </a>
          <h5 class="white-text d-md-inline align-middle indexpage__title__size show__index__name ml-md-2"><?php echo e(trans('locale.Employees')); ?></h5>
          <a href="<?php echo e(route('employees.employee.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right show__add__btn">
        ...
        <div class="card-content row">
          ...
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                ...
                <div class="form-group">
                    <input type="text" value="<?php echo e(date('d.m.Y H:i', strtotime(str_replace('/', '-', $employee->Created_At)))); ?>" class="form-control pl-0 placeholder_fonts validate" />
                </div>
            </div>
          </div>
          <div class="col-lg-6 col-12 card-width">
            <div class="input-field">
                ...
                <div class="form-group">
                    <input type="text" value="<?php echo e(date('d.m.Y H:i', strtotime(str_replace('/', '-', $employee->Updated_At)))); ?>" class="form-control pl-0 placeholder_fonts validate" />
                </div>
            </div>
          </div>
