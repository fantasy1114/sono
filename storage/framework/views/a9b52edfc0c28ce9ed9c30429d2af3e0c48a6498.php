...
<section class="users-list-wrapper section">
    ...
    <div class="row valign-wrapper mb-1 mt-1">
        <div class="col s9 m9 l9 left-align">
            <h5 class="white-text"><?php echo e(trans('keys.model_plural')); ?></h5>
            <p><?php echo auth()->user()->renderOrgName(); ?></p>
        </div>
        <div class="col s3 m3 l3 right-align">
            <a href="<?php echo e(route('keys.key.create')); ?>" class="btn-floating btn waves-effect waves-light red">
                <i class="material-icons" title="<?php echo e(trans('keys.create')); ?>">add</i>
            </a>
        </div>
    </div>
  <!-- TABLE -->
                ...
                <div class="row">
                  <div class="col s12">
                    <table id="page-length-option" class="display">
                      <thead>
                        <tr>
                          <th><?php echo e(trans('keys.Key_Name')); ?></th>
                      ...
                      <tbody>
                        <?php $__currentLoopData = $keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td><?php echo e($key->Key_Name); ?></td>
                            <td><?php echo e(optional($key->Employee)->Employee_Name); ?></td>
                            <td><?php echo e(($key->Is_Active) ? trans('locale.Yes') : trans('locale.No')); ?></td>

                            <form method="POST" action="<?php echo route('keys.key.destroy', $key->Key_ID); ?>" accept-charset="UTF-8">
                              <td class="">
                                <a class="btn-flat" href="<?php echo e(route('keys.key.show', $key->Key_ID )); ?>"><i class="material-icons dark-blue-text">remove_red_eye</i></a>
                              </td>
                              <td>
                                <a class="btn-flat" href="<?php echo e(route('keys.key.edit', $key->Key_ID )); ?>"><i class="material-icons green-text">edit</i></a>
                              </td>
                              <td>
