<?php $__env->startSection('title','Keys list'); ?>
...
<section class="users-list-wrapper section">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="col s9 m9 l9 left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(trans('keys.model_plural')); ?></h5>
            <p class="indexpage__user__explain"><?php echo auth()->user()->renderOrgName(); ?></p>
        </div>
        <div class="col s3 m3 l3 right-align pr-0">
            <a href="<?php echo e(route('keys.key.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right indexpage__add__btn">
            ...
            <div class="card">
              <div class="py-3">
                    ...
                    <table id="page-length-option" class="display">
                      <thead>
                        <tr>
                          <th class="px-3"><?php echo e(trans('keys.Key_Name')); ?></th>
                          <th><?php echo e(trans('keys.Employee_ID')); ?></th>
                          <th><?php echo e(trans('keys.Is_Active')); ?></th>
                      ...
                      <tbody>
                        <?php $__currentLoopData = $keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td class="px-3"><?php echo e($key->Key_Name); ?></td>
                            <td><?php echo e(optional($key->Employee)->Employee_Name); ?></td>
                            <td><span class="<?php echo e(($key->Is_Active) ? 'statusactive' : 'statusinactive'); ?>"><?php echo e(($key->Is_Active) ? 'Active' : 'Inactive'); ?></span></td>

                            <form method="POST" action="<?php echo route('keys.key.destroy', $key->Key_ID); ?>" accept-charset="UTF-8">
                              <td class="">
                                <a class="btn-flat" href="<?php echo e(route('keys.key.show', $key->Key_ID )); ?>"><i class="material-icons dark-blue-text"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn-flat" href="<?php echo e(route('keys.key.edit', $key->Key_ID )); ?>"><i class="material-icons green-text"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button type="submit" class="btn-flat" title="<?php echo e(trans('keys.delete')); ?>" onclick="return confirm(&quot;<?php echo e(trans('keys.confirm_delete')); ?>&quot;)">
                                    <i class="material-icons red-text"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script src="<?php echo e(('table/js/scripts/data-tables-key.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\data\10.30\li\webde\resources\views/keys/index.blade.php ENDPATH**/ ?>