...
<section class="users-list-wrapper section <?php if(Auth::user()->is_superuser == 0): ?> <?php echo e('d-none'); ?> <?php endif; ?>">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="col s9 m9 l9 left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(trans('managers.model_plural')); ?></h5>
            <p class="indexpage__user__explain" style="visibility: hidden;"><?php echo auth()->user()->renderOrgName(); ?></p>
        </div>
        <div class="col s3 m3 l3 right-align pr-0">
            <a href="<?php echo e(route('managers.manager.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right indexpage__add__btn">
            ...
            <div class="card rounded mobile_indexpage">
              <div class="py-3">
                    ...
                    <table id="page-length-option" class="display">
                      <thead>
                        <tr>
                          <th class="px-3"><?php echo e(trans('managers.name')); ?></th>
                      ...
                      <tbody>
                        <?php $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td class="px-3"><?php echo e($manager->name); ?></td>
                            <td><?php echo e($manager->email); ?></td>
                            <td><?php echo e(optional($manager->Organisation)->Organisation_Name); ?></td>
                            <td><?php echo e(($manager->is_superuser) ? trans('locale.Yes') : trans('locale.No')); ?></td>
                            <td><span class="<?php echo e(($manager->is_active) ? 'statusactive' : 'statusinactive'); ?>"><?php echo e(($manager->is_active) ? 'Active' : 'Inactive'); ?></span></td>

                            <form method="POST" action="<?php echo route('managers.manager.destroy', $manager->id); ?>" accept-charset="UTF-8">
                              <td class="">
                                <a class="btn-flat" href="<?php echo e(route('managers.manager.show', $manager->id )); ?>"><i class=""><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a class="btn-flat" href="<?php echo e(route('managers.manager.edit', $manager->id )); ?>"><i class=""><svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\data\10.30\li\webde\resources\views/managers/index.blade.php ENDPATH**/ ?>