...
<section class="users-list-wrapper section">
    ...
    <div class="row">
        <div class="col s6 m6 l6 left-align">
            <input class="btn btn-primary green" type="submit" value="<?php echo e(trans('worksites.update')); ?>">
            </form>
            <a href="<?php echo e(route('worksites.worksite.index')); ?>" class="btn waves-effect waves-light blue darken-2">Cancel</a>
        </div>
        ...
        <div class="col s2 m2 l2 right-align">
            <form method="POST" action="<?php echo route('worksites.worksite.destroy', $worksite->Worksite_ID); ?>" accept-charset="UTF-8">
                ...
                <input class="btn btn-primary red" onclick="return confirm(&quot;<?php echo e(trans('worksites.confirm_delete')); ?>&quot;)" type="submit" value="Delete">
            </form>
        </div>
