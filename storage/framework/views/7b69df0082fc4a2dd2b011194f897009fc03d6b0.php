...
<section class="users-list-wrapper section edit__index__page">
    ...
    <div class="col-12 valign-wrapper index__solid__border">
        <div class="left-align">
            <h5 class="white-text indexpage__title__size"><?php echo e(isset($title) ? $title : trans('worksites.model_plural')); ?></h5>
        </div>
        <!-- "Go Up" button -->
        <div class="col s3 m3 l3 right-align">
            <a href="<?php echo e(route('worksites.worksite.create')); ?>" class="btn waves-effect waves-light d-flex align-items-center float-right edit__add__btn">
    ...
    <form method="POST" action="<?php echo e(route('worksites.worksite.update', $worksite->Worksite_ID)); ?>"        id="edit_worksite_form" name="edit_worksite_form" accept-charset="UTF-8" class="form-horizontal">
    <div class="row">
        <!-- Edit Form -->
            ...
            <div class="card-panel edit__page__table">
                ...
                <div class="row edit__btns__group">
                    <div class="col-sm-3 col-xl-2">
                        <input class="btn btn-primary editpage__update__btn" type="submit" value="<?php echo e(trans('worksites.update')); ?>">
                        </form>
                    </div>
                    <div class="col-sm-9 col-xl-10">
                        <div class="float-left ml-sm-5">
                            <a href="<?php echo e(route('worksites.worksite.index')); ?>" class="btn waves-effect waves-light  darken-2 editpage__cancel__btn"><?php echo e(trans('locale.cancels')); ?></a>
                        </div>
                        <div class="float-right ">
                            <form method="POST" action="<?php echo route('worksites.worksite.destroy', $worksite->Worksite_ID); ?>" accept-charset="UTF-8">
                                ...
                                <input class="btn btn-primary editpage__delete__btn" onclick="return confirm(&quot;<?php echo e(trans('worksites.confirm_delete')); ?>&quot;)" type="submit" value="<?php echo e(trans('locale.deletes')); ?>">
                            </form>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\data\10.30\li\webde\resources\views/worksites/edit.blade.php ENDPATH**/ ?>